...
class ft_net(nn.Module):
    ...
    def __init__(self, class_num=62, droprate=0.5, stride=2, circle=False, ibn=False, linear_num=512):
...
class ft_net_middle(nn.Module):
    ...
    def __init__(self, class_num=62, droprate=0.5):
...
# Test the model, before you train it. 
    net = ft_net_hr(62) ### Ivy change 751 -> 61
